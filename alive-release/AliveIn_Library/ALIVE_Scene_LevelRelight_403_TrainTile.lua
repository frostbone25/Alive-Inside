ALIVE_Scene_LevelRelight_403_TrainTile = function(kScene)
    ...
    ALIVE_AgentSetProperty("light_ENV_D_SunKey", "EnvLight - Intensity", 4.5, kScene);
    ALIVE_AgentSetProperty("light_ENV_D_SunKey", "EnvLight - Intensity Specular", 1.0, kScene);
    ...
    ALIVE_AgentSetProperty("light_ENV_D_SunKey", "EnvLight - Shadow Type", 3, kScene);
    ALIVE_AgentSetProperty("light_ENV_D_SunKey", "EnvLight - Wrap", 0.025, kScene);
    ...
    ALIVE_AgentSetProperty("light_ENV_D_SunKey", "EnvLight - Intensity", 0.0, kScene);
    ALIVE_AgentSetProperty("myLight_SunAmb", "EnvLight - Intensity", 0.0, kScene);

    --sky light/color
    ALIVE_AgentSetProperty("light_SKY_amb", "EnvLight - Intensity", 1, kScene);
    ALIVE_AgentSetProperty("light_SKY_amb", "EnvLight - Color", skyColor, kScene);
    ...
    --ALIVE_AgentSetProperty("light_ENV_ambFill", "EnvLight - Intensity", 5, kScene);
    ...
    ALIVE_AgentSetProperty("obj_skydomeOverheadClouds", "Render EnvLight Shadow Cast Enable", false, kScene);
    ALIVE_AgentSetProperty("obj_skydomeOverheadClouds", "Render Shadow Force Visible", false, kScene);
    ALIVE_AgentSetProperty("obj_skydomeOverheadClouds", "Render Enlighten Force Visible", false, kScene);

    ALIVE_AgentSetProperty("obj_skydomeSun", "Render EnvLight Shadow Cast Enable", false, kScene);
    ALIVE_AgentSetProperty("obj_skydomeSun", "Render Shadow Force Visible", false, kScene);
    ALIVE_AgentSetProperty("obj_skydomeSun", "Render Enlighten Force Visible", false, kScene);
