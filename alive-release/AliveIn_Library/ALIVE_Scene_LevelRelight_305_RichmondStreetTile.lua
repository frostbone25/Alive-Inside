...
ALIVE_Scene_LevelRelight_305_RichmondStreetTile = function(kScene)
    ...
    local skyEnvlight  = AgentFindInScene("light_ENV_Amb_Skydome", kScene);
    ...
    local sunColor     = RGBColor(255, 230, 188, 255);
    ...
    ambientColor = Multiplier_RGBColor(ambientColor, 0.6);
    
    --set the alpha value of the fog color to be fully opaque
    local finalFogColor = Color(fogColor.r, fogColor.g, fogColor.b, 1.0);

    local sunRotation = Vector(110, 300, 0);
    --local sunRotation = Vector(110, 290, 0);
    ...
    ALIVE_AgentSetProperty(fogName, "Env - Fog Start Distance", 4.25, kScene);
    ALIVE_AgentSetProperty(fogName, "Env - Fog Height", 0.45, kScene);
    ALIVE_AgentSetProperty(fogName, "Env - Fog Density", 0.5, kScene);
    ALIVE_AgentSetProperty(fogName, "Env - Fog Max Opacity", 1.0, kScene);
    ALIVE_AgentSetProperty(fogName, "Env - Fog Height Falloff", 32.0, kScene);
    ...
    ALIVE_SetAgentWorldRotation("light_ENV_SunKey", sunRotation, kScene);
    --ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Type", 2, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Intensity", 6.5, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Intensity Specular", 1.0, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Enlighten Intensity", 1.0, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Radius", 1, kScene);
    --ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Distance Falloff", 1, kScene);
    --ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Spot Angle Inner", 5, kScene);
    --ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Spot Angle Outer", 45, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Color", sunColor, kScene);
    --ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Enabled Group", envlight_groupEnabled, kScene);
    --ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Groups", envlight_groups, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Shadow Type", 3, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Wrap", 0.015, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Shadow Quality", 3, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - HBAO Participation Type", 2, kScene);
    ALIVE_AgentSetProperty("light_ENV_SunKey", "EnvLight - Mobility", 2, kScene);
    ...
    ALIVE_AgentSetProperty("myLight_SunAmb", "EnvLight - Intensity", 1.25, kScene);
    ...
    --sky light/color
    ALIVE_AgentSetProperty("light_ENV_Amb_Skydome", "EnvLight - Intensity", 4, kScene);
    ALIVE_AgentSetProperty("light_ENV_Amb_Skydome", "EnvLight - Color", skyColor, kScene);

    ALIVE_AgentSetProperty("light_MAT_amb", "EnvLight - Intensity", 8, kScene);
    ALIVE_AgentSetProperty("light_MAT_amb", "EnvLight - Color", sunColor, kScene);
    ...
    ALIVE_AgentSetProperty(agent_name_scene, "FX TAA Weight", 0.5, kScene);
    ALIVE_AgentSetProperty(agent_name_scene, "FX Color Enabled", false, kScene);
    ...
    ALIVE_AgentSetProperty(agent_name_scene, "Glow Clear Color", RGBColor(0, 0, 0, 255), kScene);
    ...
    ALIVE_AgentSetProperty(agent_name_scene, "HBAO Max Distance", 40.5, kScene);
    ...
    ALIVE_AgentSetProperty(agent_name_scene, "LightEnv Tint", RGBColor(255, 255, 255, 255), kScene);
    ALIVE_AgentSetProperty(agent_name_scene, "LightEnv Background Color", RGBColor(0, 0, 0, 0), kScene);
    ALIVE_AgentSetProperty(agent_name_scene, "LightEnv Saturation", 1.0, kScene);
    ALIVE_AgentSetProperty(agent_name_scene, "LightEnv Reflection Intensity Shadow", 1.5, kScene);
    ALIVE_AgentSetProperty(agent_name_scene, "LightEnv Reflection Intensity", 1.5, kScene);
    ALIVE_AgentSetProperty(agent_name_scene, "LightEnv Reflection Tint", RGBColor(170, 230, 255, 255), kScene);
    ALIVE_AgentSetProperty(agent_name_scene, "LightEnv Shadow Max Distance", 80.0, kScene);
    ALIVE_AgentSetProperty(agent_name_scene, "LightEnv Dynamic Shadow Max Distance", 80.0, kScene);
